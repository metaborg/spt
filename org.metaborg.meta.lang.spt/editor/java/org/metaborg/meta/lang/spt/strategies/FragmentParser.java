...
public class FragmentParser {
    ...
    public IStrategoTerm parse(String input, IStrategoTerm fragment, boolean ignoreSetup) throws ParseException
    {
        ...
        if(parsed == null || !ALLOW_CACHING) {
            final ISpoofaxParseUnit parseResult = syntaxService.parse(fragmentInput, sptFile, language, new JSGLRParserConfiguration(true, true, false, FRAGMENT_PARSE_TIMEOUT));
