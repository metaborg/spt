...
public interface ITestCaseBuilder<T, TF> {
     ...
     */
    ITestCaseBuilder<T, TF> withTestFixture(TF testFixture);
     ...
     * @return the same builder for chaining calls.
     */
    ITestCaseBuilder<T, TF> withResource(FileObject resource);
     ...
     * @return the same builder for chaining calls.
     */
    ITestCaseBuilder<T, TF> withProject(IProject project);
     ...
     * @return the same builder for chaining calls.
     */
    ITestCaseBuilder<T, TF> withTest(T test);
