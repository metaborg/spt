...
public class TestingTestingParseControllerGenerated extends DynamicParseController 
{ 
  ...
  { 
    try
    { 
      InputStream descriptorStream = TestingTestingParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = TestingTestingParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(TestingTestingParseControllerGenerated.class);
    }
