...
public class run_spt_core_0_0 extends Strategy {
    ...
    @Override public IStrategoTerm invoke(Context strategoContext, IStrategoTerm current) {
        ...
        // logger.debug("Trying to analyze SPT testsuite: {}\n located at {}, in project {}.", baseAst,
        // relativePathString, projectPathString);
        //
        ...
        // }
        //
        // private static void gatherMessages(IStrategoTerm defaultTerm, FileObject testSuite, Iterable<IMessage>
        // messages,
        ...
        // *
        // * Spoofax core uses ISourceRegions for messages. Spoofax itself uses an ATerm and a String as a message. It
        // then
        // * uses an ImploderAttachment (or an OriginAttachment returning a term with an ImploderAttachment) to get the
        // region
        // * of the term and displays the message there.
        // *
        // * This makes a lot of sense from a Stratego point of view, where you just give the term you want the message
        // to be
        // * on, but it doesn't make sense for us, as we get the message as an IMessage with an ISourceRegion, and then
        // have
        // * to find the term that belongs to it, only to get that transformed back into a start and end offset.
        // *
        // * The question is: where do we find this term? It could be in a parsed fragment, or it could be in the SPT
        // AST. The
        // * old SPT did its error checking in Stratego, so it didn't have this problem.
        // *
        // * The hacky workaround is to just create a term with a custom ImploderAttachment with tokens on a bogus
        // Tokenizer,
        // * just to get the offsets right.
        // *
        // * In the future, we probably want to either look up the appropriate term (unnecessary work), or report the
        // messages
        ...
        // ImploderAttachment imploder =
        // ImploderAttachment.createCompactPositionAttachment(testSuite.getName().toString(),
